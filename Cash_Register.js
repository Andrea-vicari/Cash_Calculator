/*
alert(`
1) PULIRE IL CODICE E COMMENTARE SE POSSIBILE
2) CLONARE CR.JS TOGLIENDO CONSOLE.LOG, LASCIANDONE UNA CON UNA SENZA
...
// If the last letter is k, it means the page comes from a valid TX
// See function refreshPageTXOK() functions, that adds ?tx_ok if
// a valid TX is present
if(lastLetter !="k"){
...
// Refresh the page and add suffix "invalid" if the Tx is not valid
function refreshPageAndADD(){
    location.reload();

}
// Refresh the page and add suffix "tx_ok" if the Tx is valid
function refreshPageTXOK(){
    window.location = `?tx_ok`;
}
